...
STRINGS = {
    "zh": {
        ...
        "help___lr_model": "模型文件（默认 auto_tone.npz）",
        ...
        "help___masks": "局部蒙版: “name:type:params;...”，type=linear/radial/color，相对坐标 0-1（如 “sky:linear:0.5,0,0.5,1,feather=0.3”）",
        "help___mask_adjust": "蒙版内局部调整: “name:key=value,...;...”，key=exposure/brightness/contrast/saturation/vibrance/clarity/texture/sharpen/temp/tint/blur",
    ...
    "en": {
        ...
        "help___lr_model": "Model file (default auto_tone.npz)",
        ...
        "help___masks": "Local masks: “name:type:params;...” with type=linear/radial/color, relative 0-1 coords (e.g. “sky:linear:0.5,0,0.5,1,feather=0.3”)",
        "help___mask_adjust": "Per-mask local adjustments: “name:key=value,...;...” with key=exposure/brightness/contrast/saturation/vibrance/clarity/texture/sharpen/temp/tint/blur",
