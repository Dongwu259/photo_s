...
STRINGS = {
    "zh": {
        ...
        # ── v2.6 autopilot mode ──
        "watch_mode": "处理模式",
        "watch_mode_basic": "基础监视（当前设置）",
        "watch_mode_suggest": "智能建议（suggest）",
        "watch_mode_auto_tone": "AI 调色（auto-tone）",
        "watch_mode_both": "建议 + AI 调色",
        "watch_strength": "AI 强度",
        "watch_ap_write_xmp": "写回 XMP",
        "watch_scan_existing": "启动时处理已有图片",
        "watch_open_out": "打开输出目录",
        "watch_out_missing": "输出目录尚不存在（启动后创建）",
        "ap_event_pass": "✅ {name} → {dir}　（通过 {p} · 复查 {r} · 失败 {e}）",
        "ap_event_review": "👀 {name} → 复查（{reason}）　（通过 {p} · 复查 {r} · 失败 {e}）",
        "ap_event_error": "❌ {name}：{err}",
        "ap_start_failed": "启动失败：{err}",
        # ── Contact sheet ──
        "contact_title": "联系表",
        "contact_output": "输出文件",
        "contact_cols": "列数",
    ...
    "en": {
        ...
        # ── v2.6 autopilot mode ──
        "watch_mode": "Mode",
        "watch_mode_basic": "Basic watcher (these settings)",
        "watch_mode_suggest": "Smart suggest",
        "watch_mode_auto_tone": "AI tone (auto-tone)",
        "watch_mode_both": "Suggest + AI tone",
        "watch_strength": "AI strength",
        "watch_ap_write_xmp": "Write XMP",
        "watch_scan_existing": "Process existing images on start",
        "watch_open_out": "Open output folder",
        "watch_out_missing": "Output folder doesn't exist yet (created on start)",
        "ap_event_pass": "✅ {name} → {dir}  (passed {p} · review {r} · failed {e})",
        "ap_event_review": "👀 {name} → review ({reason})  (passed {p} · review {r} · failed {e})",
        "ap_event_error": "❌ {name}: {err}",
        "ap_start_failed": "Start failed: {err}",
        # ── Contact sheet ──
