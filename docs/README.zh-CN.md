...
给摄影师一套完整的 Tkinter GUI（视觉预览、审查打分灯箱、去重查看器、画廊导出），
...
破坏性操作必须显式传参。完整契约见 [`docs/AGENT_API.md`](AGENT_API.md)。
...
| [`docs/ROADMAP.md`](ROADMAP.md) | 版本路线（v1.6.0：Lightroom 方向调色） |
