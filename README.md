...
| Path | Entry point |
|---|---|
| **MCP server** — 18 tools (process / select / hdr / blurfaces / dedup / …) | `claude mcp add photo-s -- photo-s mcp` |
...
| MCP server | — | ✅ | 18 tools to MCP clients (Claude Desktop / Claude Code / any MCP client) |
...
PhotoS is a **batch / delivery pipeline**, not an interactive editor — no brush
masks, no RAW-domain editing, no lens correction.
